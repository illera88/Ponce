...
//@}
  ...
  ui_obsolete_set_nav_colorizer, ///< ui: see set_nav_colorizer()
...
#define CVNF_ACT  (1 << 2) ///< activate (i.e., switch to) the viewer.
  ...
  ui_obsolete_dbg_map_binary_path,
  ui_obsolete_dbg_modify_binary_paths,
...
struct action_ctx_base_t
{
  ...
  intvec_t chooser_selection;     ///< current chooser selection (1-based)
...
inline bool get_chooser_data(
        qstrvec_t *out, const char *chooser_caption, uint32 n)
{
